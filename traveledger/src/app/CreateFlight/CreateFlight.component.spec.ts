...
describe('CreateFlightComponent', () => {
  ...
  let mockCreateFlightService;
  let mockDataService

  beforeEach(async(() => {

    mockCreateFlightService = sinon.createStubInstance(CreateFlightService);
    mockCreateFlightService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: CreateFlightService, useValue: mockCreateFlightService },
